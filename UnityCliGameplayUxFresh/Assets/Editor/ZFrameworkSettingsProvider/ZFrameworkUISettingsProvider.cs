...
public static class ZFrameworkUISettingsProvider
{
    private static ReorderableList _reorderableList;

    [MenuItem("ZFramework/Settings/ZFrameworkUISettings", priority = -1)]
    public static void OpenSettings() => SettingsService.OpenProjectSettings("Project/ZFramework/UISettings");

    private const string SettingsPath = "Project/ZFramework/UISettings";
    ...
    public static SettingsProvider CreateUIGeneratorSettingsProvider()
    {
        return new SettingsProvider(SettingsPath, SettingsScope.Project)
        {
            ...
            {
                "ZFramework", "Settings", "Custom", "UISettings"
            })
        };
    }
    ...
    private static void DrawHeader()
    {
        ...
        EditorGUILayout.LabelField(new GUIContent("ZFramework UI代码生成器", "UI Script Generator Configuration"),
