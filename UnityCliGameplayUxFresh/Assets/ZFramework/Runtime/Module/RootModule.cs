...
namespace ZFramework
{
    ...
    public sealed class RootModule : MonoBehaviour
    {
        ...
        [SerializeField]
        private string textHelperTypeName = "ZFramework.DefaultTextHelper";

        [SerializeField]
        private string logHelperTypeName = "ZFramework.DefaultLogHelper";

        [SerializeField]
        private string jsonHelperTypeName = "ZFramework.DefaultJsonHelper";
