...
namespace ZFramework
{
    ...
    public static class ReleaseTools
    {
        ...
        [MenuItem("ZFramework/Build/一键打包AssetBundle _F8")]
        ...
        [MenuItem("ZFramework/Build/一键打包Window", false, 30)]
        ...
        [MenuItem("ZFramework/Build/一键打包Android", false, 30)]
        ...
        [MenuItem("ZFramework/Build/一键打包IOS", false, 30)]
        ...
        public static void BuildWithConfig(BuildConfig config, bool buildPlayer)
        {
            ...
            // 3. [最小包] 删除 StreamingAssets 中的 .bundle 文件
