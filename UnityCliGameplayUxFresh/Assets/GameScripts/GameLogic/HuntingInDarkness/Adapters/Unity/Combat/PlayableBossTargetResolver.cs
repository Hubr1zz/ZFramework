...
{
    public interface IPlayableBossIntentCommands
    {
        bool TryMoveBoss(UnityEngine.Vector2Int destination);
        void AddFate(int hunterId, int amount);
        InspirationGain AddMindBurden(int hunterId, string displayName);
    }
