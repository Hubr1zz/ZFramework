...
namespace GameplayBase.CombatSystem
{
    ...
    public class HitLocationRuntimeState
    {
        ...
        public int CurrentHp
        {
            ...
            set => _domainState.Restore(value, IsDestroyed, IsFaceUp, IsPersistentActive);
        }
        public bool IsDestroyed
        {
            get => _domainState.IsDestroyed;
            set => _domainState.Restore(CurrentHp, value, IsFaceUp, IsPersistentActive);
        }
        public bool IsFaceUp
        {
            get => _domainState.IsFaceUp;
            set => _domainState.Restore(CurrentHp, IsDestroyed, value, IsPersistentActive);
        }
        public bool IsPersistentActive => _domainState.IsPersistentActive;
        ...
        public HitLocationRuntimeState(HitLocationCardData data)
        {
            ...
            _domainState = new HitLocationState(new HitLocationDefinition(
                ...
                data.maxHp,
                data.persistent,
                data.previousSuccessToughnessModifier));
        }

        public void Reveal() => _domainState.Reveal();
        public void Hide() => _domainState.Hide();
        public void ActivatePersistent() => _domainState.ActivatePersistent();
