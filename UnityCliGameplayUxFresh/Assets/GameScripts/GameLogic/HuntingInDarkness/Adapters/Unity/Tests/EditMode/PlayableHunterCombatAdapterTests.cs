...
namespace HuntingInDarkness.Adapter.Tests
{
    public sealed class PlayableHunterCombatAdapterTests
    {
        ...
        public void PlayableBossContent_CreatesAttackAndPublishesVictoryAfterEveryPartIsDestroyed()
        {
            ...
            Assert.That(attackData.TargetPolicy, Is.EqualTo(BossTargetPolicy.Nearest));
            Assert.That(attackData.MovementDistance, Is.EqualTo(1));
            Assert.That(attackData.AttackRange, Is.EqualTo(1));
            Assert.That(attackData.MindBurdenName, Is.EqualTo("死亡逼近"));
