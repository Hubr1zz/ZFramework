...
namespace UI
{
    ...
    public class CameraController : MonoBehaviour
    {
        ...
        private void ApplyBoardFraming()
        {
            ...
            TabletopCameraFraming.CalculatePerspectivePose(camera, bounds, _pitch, _yaw, 1f + boardFramingPadding / diameter, minFocusDistance, out _targetPos, out _targetRot);
        ...
        private void HandleWasdPan()
        {
            ...
            orbitTarget += move * (panSpeed * GlobalGameSettings.CameraPanSpeed * Time.deltaTime);
