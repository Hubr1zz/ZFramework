...
namespace UI
{
    ...
    public class SquadZone : MonoBehaviour
    {
        ...
        public bool HasDepartureCard => _departureCard != null;
        ...
        public void SetRefs(SlotGrid squadGrid, DepartureCard departureCard = null)
        {
            if (_departureCard != null) _departureCard.OnDepart -= RequestDeparture;
            _squadGrid = squadGrid;
            _departureCard = departureCard;
            if (_departureCard != null) _departureCard.OnDepart += RequestDeparture;
        }
