...
namespace Cards3D
{
    ...
    public class BossHitLocationCard : CardView3D
    {
        ...
        public HitLocationRuntimeState State => _state;
        ...
        protected override void ApplyVisuals()
        {
            ...
            else if (_state.IsFaceUp)
            {
                ...
                _hpText.text     = _state.IsPersistentActive ? $"持续留场 · HP {_state.CurrentHp}/{_state.Data.maxHp}" : $"HP {_state.CurrentHp}/{_state.Data.maxHp}";
            }
            else
            {
