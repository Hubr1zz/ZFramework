...
namespace ZFramework.RTS.Editor
{
    ...
    {
        private const string COMPILER_PROJECT = "Packages/com.zframework.rts/Tools~/Compiler/ZFramework.RTS.Compiler.csproj";
        ...
        private static void StartCompile()
        {
            try
            {
                ...
                string lockDirectory = Path.Combine(settings.ProjectRoot, "Library", "ZFrameworkRTS", "locks");
