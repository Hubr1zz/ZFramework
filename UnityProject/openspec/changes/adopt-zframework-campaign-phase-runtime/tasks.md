...
- [x] 1.10 将 HuntManager、Hunt ActionSession、探索环境与远征身份收敛为可交换 generation
- [x] 1.11 以 generation 身份隔离迟到检查点、遭遇、完成与撤退异步结果

## 2. 验证

- [x] 2.1 Unity CLI 编译通过
- [x] 2.2 ActionEnvironment/Campaign Runner EditMode 13/13 通过
- [x] 2.3 Campaign Runtime lease/generation 定向 PlayMode 10/10 通过
