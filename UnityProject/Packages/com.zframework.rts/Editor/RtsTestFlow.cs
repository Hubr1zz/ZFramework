...
namespace ZFramework.RTS.Editor
{
    ...
    internal static class RtsTestFlow
    {
        ...
        private const string PENDING_KEY = "ZFramework.RTS.TestFlow.Pending";
        private const string ASSEMBLY_PATH_KEY = "ZFramework.RTS.TestFlow.AssemblyPath";
        private const string PROFILE_KEY = "ZFramework.RTS.TestFlow.Profile";
        private const string SESSION_ID_KEY = "ZFramework.RTS.TestFlow.SessionId";
        private const string BOOTSTRAP_REQUEST_PATH = "Library/ZFrameworkRTS/recreate-bootstrap.request";
        ...
        private static void EnsureTestSceneMarker(string projectRoot)
        {
            ...
            File.WriteAllText(markerPath, "Generated by the ZFramework RTS test flow. Safe for Zero-RTS export to remove.\n");
