...
if ([string]::IsNullOrWhiteSpace($Output)) {
    $Output = Join-Path $ProjectPath 'Temp/RTSPlayerBuild/TEngineRTSTest.exe'
}
...
Invoke-Unity -Arguments @('-executeMethod', 'TEngine.RTS.Editor.RtsSourcePromotion.ExportZeroRtsForBatch') -LogName 'rts-production-export'
$buildArguments = @(
    '-executeMethod', 'TEngine.RTS.Editor.RtsCiBuild.BuildPlayerForBatch',
