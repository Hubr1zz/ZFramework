...
namespace AgentWorkflow.Editor
{
    public sealed partial class AgentWorkbenchWindow : EditorWindow
    {
        ...
        [Serializable]
        private sealed class FormalImplementation
        {
            ...
            public string codeReadiness;
            public FormalImplementationVerification verification;
            public string[] implementationOutline;
            public EditorGuidance editorGuidance;
            public string[] sourceReferences;
        }
        ...
        [Serializable]
        private sealed class FormalImplementationVerification
        {
            public string status;
            public string summary;
            public string validatedAgainstSpecHash;
            public CodeEvidence[] evidence;
            public string[] tests;
            public string verifiedAt;
        }
        ...
        [Serializable]
        private sealed class ImplementationRoutingSummary
        {
            public int schemaVersion = 2;
            public string role;
            public string inputDigest;
            public string inputManifestDigest;
            public string outputDigest;
            public ImplementationManifestEntry[] inputManifest;
            public ImplementationRoutingEntry[] requirements;
        }

        [Serializable]
        private sealed class ImplementationManifestEntry
        {
            public string path;
        ...
        [Serializable]
        private sealed class ImplementationRoutingEntry
        {
            public string id;
            public string label;
            ...
            public string verificationStatus;
            public string summary;
            public ImplementationDesignSource[] designSources;
            public string[] sources;
            public ImplementationEvidenceState[] evidence;
        }

        [Serializable]
        private sealed class ImplementationDesignSource
        {
            public string sourceId;
            public string path;
        }
        ...
        [Serializable]
        private sealed class ImplementationEvidenceState
        {
            public string path;
            public string state;
        }
        ...
        private sealed class DesignDocumentFileCandidate
        {
            public DesignSourceEntry source;
