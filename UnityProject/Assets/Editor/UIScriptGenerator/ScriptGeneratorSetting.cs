...
namespace ZFramework.Editor.UI
{
    ...
    public class ScriptGeneratorSetting : ScriptableObject
    {
        ...
        [SerializeField] private string genCodePath = "Assets/GameScripts/GameLogic/UI/Gen";
        [SerializeField] private string impCodePath = "Assets/GameScripts/GameLogic/UI";
