...
.AppToolbar
{
     background-color: #222222;
        ...
        static void UpdatePropertyEditorTitle(EditorWindow propertyEditor)
        {
            ...
            {
                if (adjustedObjectIconsBySourceIid.TryGetValue(sourceIcon.GetLegacyInstanceId(), out adjustedIcon)) return;
                ...
                adjustedObjectIconsBySourceIid[sourceIcon.GetLegacyInstanceId()] = adjustedIcon;
...
#if UNITY_6000_3_OR_NEWER
                    var folderIid = m_rootInstanceID.ToLegacyInstanceId();
#else
...
#if UNITY_6000_3_OR_NEWER
                    data.SetMemberValue("m_rootInstanceID", default(EntityId));
#else
            ...
            void handleFolderChange()
            {
                ...
                void onUndoRedo()
                {
                    ...
                    EditorApplication.delayCall += () =>
                    {
                        ...
                        var folderIid = AssetDatabase.LoadAssetAtPath<Object>(AssetDatabase.GUIDToAssetPath(delayedFolderGuid)).GetLegacyInstanceId();

#if UNITY_6000_3_OR_NEWER
                        browser.InvokeMethod("SetFolderSelection", new[] { folderIid.ToEntityId() }, false);
#else
