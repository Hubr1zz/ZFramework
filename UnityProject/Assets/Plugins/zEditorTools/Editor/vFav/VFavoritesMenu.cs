...
namespace VFavorites
{
    ...
    public class VFavoritesMenu
    {
        ...
        const string menuEmbeddedPanelUsesWindowUI = dir + "Use panel UI in Project window";
        const string debugLogging = dir + "Debug logging";
        ...
        [MenuItem(menuEmbeddedPanelUsesWindowUI, false, 104)] static void ToggleEmbeddedPanelUsesWindowUI() => embeddedPanelUsesWindowUI = !embeddedPanelUsesWindowUI;
        [MenuItem(menuEmbeddedPanelUsesWindowUI, true, 104)] static bool ValidateEmbeddedPanelUsesWindowUI() { Menu.SetChecked(menuEmbeddedPanelUsesWindowUI, embeddedPanelUsesWindowUI); return !pluginDisabled; }

        [MenuItem(debugLogging, false, 105)] static void ToggleDebugLogging() => debugLoggingEnabled = !debugLoggingEnabled;
        [MenuItem(debugLogging, true, 105)] static bool ValidateDebugLogging() { Menu.SetChecked(debugLogging, debugLoggingEnabled); return !pluginDisabled; }
