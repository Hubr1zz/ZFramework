...
namespace VHierarchy
{
    class VHierarchyMenu
    {
        ...
        public static bool activationToggleEnabled { get => EditorPrefsCached.GetBool("vHierarchy-activationToggleEnabled", true); set => EditorPrefsCached.SetBool("vHierarchy-activationToggleEnabled", value); }
        public static bool hierarchyLinesEnabled { get => EditorPrefsCached.GetBool("vHierarchy-hierarchyLinesEnabled", true); set => EditorPrefsCached.SetBool("vHierarchy-hierarchyLinesEnabled", value); }
        public static bool minimalModeEnabled { get => EditorPrefsCached.GetBool("vHierarchy-minimalModeEnabled", true); set => EditorPrefsCached.SetBool("vHierarchy-minimalModeEnabled", value); }
        public static bool zebraStripingEnabled { get => EditorPrefsCached.GetBool("vHierarchy-zebraStripingEnabled", true); set => EditorPrefsCached.SetBool("vHierarchy-zebraStripingEnabled", value); }
        ...
        public static bool deleteEnabled { get => EditorPrefsCached.GetBool("vHierarchy-deleteEnabled", false); set => EditorPrefsCached.SetBool("vHierarchy-deleteEnabled", value); }
        ...
        public static bool isolateEnabled { get => EditorPrefsCached.GetBool("vHierarchy-collapseEverythingElseEnabled", false); set => EditorPrefsCached.SetBool("vHierarchy-collapseEverythingElseEnabled", value); }
        public static bool collapseEverythingEnabled { get => EditorPrefsCached.GetBool("vHierarchy-collapseEverythingEnabled", false); set => EditorPrefsCached.SetBool("vHierarchy-collapseEverythingEnabled", value); }
        public static bool setDefaultParentEnabled { get => EditorPrefsCached.GetBool("vHierarchy-setDefaultParentEnabled", false); set => EditorPrefsCached.SetBool("vHierarchy-setDefaultParentEnabled", value); }
