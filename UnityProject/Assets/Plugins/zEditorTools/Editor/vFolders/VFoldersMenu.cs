...
namespace VFolders
{
    class VFoldersMenu
    {
        ...
        public static bool twoLineNamesEnabled { get => EditorPrefsCached.GetBool("vFolders-twoLineNamesEnabled", true); set => EditorPrefsCached.SetBool("vFolders-twoLineNamesEnabled", value); }
        ...
        public static bool hierarchyLinesEnabled { get => EditorPrefsCached.GetBool("vFolders-hierarchyLinesEnabled", true); set => EditorPrefsCached.SetBool("vFolders-hierarchyLinesEnabled", value); }
        public static bool zebraStripingEnabled { get => EditorPrefsCached.GetBool("vFolders-zebraStripingEnabled", true); set => EditorPrefsCached.SetBool("vFolders-zebraStripingEnabled", value); }
        public static bool contentMinimapEnabled { get => EditorPrefsCached.GetBool("vFolders-contentMinimapEnabled", true); set => EditorPrefsCached.SetBool("vFolders-contentMinimapEnabled", value); }
        ...
        public static bool collapseEverythingElseEnabled { get => EditorPrefsCached.GetBool("vFolders-collapseEverythingElseEnabled", false); set => EditorPrefsCached.SetBool("vFolders-collapseEverythingElseEnabled", value); }
