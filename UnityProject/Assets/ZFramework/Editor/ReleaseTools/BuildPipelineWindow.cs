...
namespace ZFramework
{
    public class BuildPipelineWindow : EditorWindow
    {
        ...
        [MenuItem("ZFramework/Build/打包工具窗口", false, 0)]
        public static void ShowWindow()
        {
            var window = GetWindow<BuildPipelineWindow>("ZFramework 打包工具");
        ...
        private void DrawHeader()
        {
            ...
            EditorGUILayout.LabelField("ZFramework 打包工具", titleStyle, GUILayout.Height(30));
            GUILayout.FlexibleSpace();
        ...
        private void LoadSettings()
        {
            ...
            _platformIndex = EditorPrefs.GetInt("ZFramework_BP_BuildTarget", -1);
            ...
            int pipelineIndex = EditorPrefs.GetInt("ZFramework_BP_BuildPipeline", 0);
            _config.BuildPipeline = pipelineIndex == 1 ? EBuildPipeline.BuiltinBuildPipeline : EBuildPipeline.ScriptableBuildPipeline;

            _config.CompressOption = (ECompressOption)EditorPrefs.GetInt("ZFramework_BP_CompressOption", 1);
            _config.EncryptionType = (EncryptionType)EditorPrefs.GetInt("ZFramework_BP_EncryptionType", 0);

            _config.PackageVersion = EditorPrefs.GetString("ZFramework_BP_PackageVersion", "");
            _config.OutputRoot = EditorPrefs.GetString("ZFramework_BP_OutputRoot", "./Builds/");

            _config.MinimalPackage = EditorPrefs.GetBool("ZFramework_BP_MinimalPackage", false);
            _config.RetainTags = EditorPrefs.GetString("ZFramework_BP_RetainTags", "");

            _config.EnableSharePackRule = EditorPrefs.GetBool("ZFramework_BP_EnableSharePack", true);
            _config.UseAssetDependencyDB = EditorPrefs.GetBool("ZFramework_BP_UseDepDB", true);
            _config.ClearBuildCache = EditorPrefs.GetBool("ZFramework_BP_ClearCache", false);
            _config.VerifyBuildingResult = EditorPrefs.GetBool("ZFramework_BP_VerifyResult", true);
            _config.BuildinFileCopyOption = (EBuildinFileCopyOption)EditorPrefs.GetInt("ZFramework_BP_CopyOption", 0);
            _config.FileNameStyle = (EFileNameStyle)EditorPrefs.GetInt("ZFramework_BP_FileNameStyle", 1);

            _config.BuildPlayer = EditorPrefs.GetBool("ZFramework_BP_BuildPlayer", false);

            _playerPlatformIndex = EditorPrefs.GetInt("ZFramework_BP_PlayerPlatform", -1);
            ...
            _config.PlayerOutputPath = EditorPrefs.GetString("ZFramework_BP_PlayerOutput",
                BuildConfig.GetDefaultPlayerOutputPath(_config.PlayerPlatform));
        }

        private void SaveSettings()
        {
            EditorPrefs.SetInt("ZFramework_BP_BuildTarget", _platformIndex);
            EditorPrefs.SetInt("ZFramework_BP_BuildPipeline", _config.BuildPipeline == EBuildPipeline.BuiltinBuildPipeline ? 1 : 0);
            EditorPrefs.SetInt("ZFramework_BP_CompressOption", (int)_config.CompressOption);
            EditorPrefs.SetInt("ZFramework_BP_EncryptionType", (int)_config.EncryptionType);
            EditorPrefs.SetString("ZFramework_BP_PackageVersion", _config.PackageVersion);
            EditorPrefs.SetString("ZFramework_BP_OutputRoot", _config.OutputRoot);
            EditorPrefs.SetBool("ZFramework_BP_MinimalPackage", _config.MinimalPackage);
            EditorPrefs.SetString("ZFramework_BP_RetainTags", _config.RetainTags);
            EditorPrefs.SetBool("ZFramework_BP_EnableSharePack", _config.EnableSharePackRule);
            EditorPrefs.SetBool("ZFramework_BP_UseDepDB", _config.UseAssetDependencyDB);
            EditorPrefs.SetBool("ZFramework_BP_ClearCache", _config.ClearBuildCache);
            EditorPrefs.SetBool("ZFramework_BP_VerifyResult", _config.VerifyBuildingResult);
            EditorPrefs.SetInt("ZFramework_BP_CopyOption", (int)_config.BuildinFileCopyOption);
            EditorPrefs.SetInt("ZFramework_BP_FileNameStyle", (int)_config.FileNameStyle);
            EditorPrefs.SetBool("ZFramework_BP_BuildPlayer", _config.BuildPlayer);
            EditorPrefs.SetInt("ZFramework_BP_PlayerPlatform", _playerPlatformIndex);
            EditorPrefs.SetString("ZFramework_BP_PlayerOutput", _config.PlayerOutputPath);
        }
