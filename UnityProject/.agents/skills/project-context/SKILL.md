...
description: ZFramework Unity 项目速查与低成本路由。用于开始项目任务、判断代码入口、选择共享 skill 和定位文档或工程能力。
---
...
- 框架：ZFramework，使用 YooAsset、UniTask、Luban；`GameLogic` 与 `GameProto` 随 Player 编译。
