...
The production adaptor binds the same Data to `CombatPreviewView` and the existing ZFramework procedure/module/scene startup. It is created by that existing composition root. It must not auto-create itself.
