...
> **适用场景**：SetSprite/LoadGameObjectAsync/LoadAssetAsync 加载、UnloadAsset/UnloadUnusedAssets 卸载、资源版本与下载 API | **关联文档**：[resource-patterns.md](resource-patterns.md)（生命周期模式）、[ui-lifecycle.md](ui-lifecycle.md)（窗口内资源释放时机）
