...
```bat
# 在 ZFramework/Configs/GameConfig/ 目录下运行
...
- 程序集与发布边界见 [assembly-content-workflow.md](assembly-content-workflow.md)
