---
name: wiki-sync
description: 同步 TEngine 项目 Wiki 与代码事实。用于用户要求同步 repowiki、修正文档与代码不一致或更新 Wiki 导航时。
---
...
3. 读取 `repowiki/zh/content/index.md` 和命中的 Wiki 页面，并按需读取 `.agents/skills/tengine-dev/references/`。
